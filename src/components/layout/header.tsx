...
/**
 * Header global — search (⌘K) + tanggal di kanan + bell + toggle tema.
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-2 border-b border-border bg-background/80 px-4 backdrop-blur md:gap-4 md:px-6">
